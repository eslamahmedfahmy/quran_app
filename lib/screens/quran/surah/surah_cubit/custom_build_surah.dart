...
class CustomBuildSurah extends StatefulWidget {
  ...
  @override
  _CustomBuildSurahState createState() => _CustomBuildSurahState();
}

class _CustomBuildSurahState extends State<CustomBuildSurah> {
  bool view = false;
