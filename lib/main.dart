...
import 'screens/home_layout/home_cubit/start_screen.dart';
    ...
    return BlocProvider(
      ...
      child: GetMaterialApp(
        ...
        theme: ThemeData(
          ...
          colorScheme: ColorScheme.fromSwatch(primarySwatch: Colors.indigo).copyWith(background: AppColor.buttonBackgroundColor),
        ),
